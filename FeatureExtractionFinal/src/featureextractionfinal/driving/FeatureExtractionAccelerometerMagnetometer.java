 ...
 * @author Ivan
 */
public class FeatureExtractionAccelerometerMagnetometer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2162; i++) {
            ...
            String line_to_file = line_acc + "\t" + line_mag;

            try (FileWriter fw = new FileWriter("results/driving/accelerometer_magnetometer.txt", true);
                    BufferedWriter bw = new BufferedWriter(fw);
                    PrintWriter out = new PrintWriter(bw)) {
                out.println(line_to_file);
            } catch (IOException e) {
                Logger.getLogger(FeatureExtractionAccelerometerMagnetometer.class.getName()).log(Level.SEVERE, null, e);
            }
        }
