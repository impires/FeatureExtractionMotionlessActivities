 ...
 * @author Ivan
 */
public class FeatureExtractionAccelerometerDistance {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2162; i++) {
            ...
            if (Double.parseDouble(line_dist) > 0) {
                ...
                String line_to_file = line_acc + "\t" + line_dist;

                try (FileWriter fw = new FileWriter("results/driving/accelerometer_distance.txt", true);
                        BufferedWriter bw = new BufferedWriter(fw);
                        PrintWriter out = new PrintWriter(bw)) {
                    out.println(line_to_file);
                } catch (IOException e) {
                    Logger.getLogger(FeatureExtractionAccelerometerDistance.class.getName()).log(Level.SEVERE, null, e);
                }
            }
        }
