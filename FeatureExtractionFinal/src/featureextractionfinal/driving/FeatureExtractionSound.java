    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2162; i++) {
            ...
            try {
                ...
                File dir = new File("data/driving/" + i);
                ...
                FileReader fileReader = new FileReader("data/driving/" + i + "/sound.txt");
                ...
                try (FileWriter fw = new FileWriter("results/driving/sound.txt", true);
