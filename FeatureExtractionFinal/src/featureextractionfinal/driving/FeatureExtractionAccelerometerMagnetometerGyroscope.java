 ...
 * @author Ivan
 */
public class FeatureExtractionAccelerometerMagnetometerGyroscope {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2162; i++) {
            ...
            String line_to_file = line_acc + "\t" + line_mag + "\t" + line_gir;

            try (FileWriter fw = new FileWriter("results/driving/accelerometer_magnetometer_gyroscope.txt", true);
                    BufferedWriter bw = new BufferedWriter(fw);
                    PrintWriter out = new PrintWriter(bw)) {
                out.println(line_to_file);
            } catch (IOException e) {
                Logger.getLogger(FeatureExtractionAccelerometerMagnetometerGyroscope.class.getName()).log(Level.SEVERE, null, e);
            }
        }
