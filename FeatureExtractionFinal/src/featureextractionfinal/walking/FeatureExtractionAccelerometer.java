 ...
 */
package featureextractionfinal.walking;
 ...
 * @author Ivan
 */
public class FeatureExtractionAccelerometer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2027; i++) {
            ...
            try {
                ...
                File f = new File("data/walking/" + i + "/");
                ...
                FileReader fileReader = new FileReader("data/walking/" + i + "/accelerometer.txt");
                ...
                try (FileWriter fw = new FileWriter("results/walking/accelerometer.txt", true);
                        BufferedWriter bw = new BufferedWriter(fw);
                        PrintWriter out = new PrintWriter(bw)) {
                    out.println(line_to_file);
                } catch (IOException e) {
                    Logger.getLogger(FeatureExtractionAccelerometer.class.getName()).log(Level.SEVERE, null, e);
                }

            } catch (FileNotFoundException ex) {
                Logger.getLogger(FeatureExtractionAccelerometer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
