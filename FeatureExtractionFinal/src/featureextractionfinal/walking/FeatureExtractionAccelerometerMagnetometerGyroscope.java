...
public class FeatureExtractionAccelerometerMagnetometerGyroscope {
    ...
    public static String getRow(String folder, String filename) {
        ...
        try {
            ...
            FileReader fileReader = new FileReader("data/walking/" + folder + "/" + filename + ".txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2027; i++) {
            ...
            try (FileWriter fw = new FileWriter("results/walking/accelerometer_magnetometer_gyroscope.txt", true);
