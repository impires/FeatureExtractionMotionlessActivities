 ...
 */
package featureextractionfinal.standing;
...
public class FeatureExtractionAccelerometerMagnetometerDistance {
    ...
    public static String getRow(String folder, String filename) {
        ...
        try {
            ...
            FileReader fileReader = new FileReader("data/standing/" + folder + "/" + filename + ".txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 3042; i++) {
            ...
            if (Double.parseDouble(line_dist) > 0) {
                ...
                try (FileWriter fw = new FileWriter("results/standing/accelerometer_magnetometer_distance.txt", true);
