 ...
 */
package featureextractionfinal.hall;
...
public class FeatureExtractionSound {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2000; i++) {
            ...
            String line_to_file = getRow("downstairs", i + "", "sound");

            if(line_to_file != null) {

                try (FileWriter fw = new FileWriter("results/hall/sound.txt", true);
        ...
        for (int i = 1; i <= 2074; i++) {
            ...
            String line_to_file = getRow("upstairs", i + "", "sound");
