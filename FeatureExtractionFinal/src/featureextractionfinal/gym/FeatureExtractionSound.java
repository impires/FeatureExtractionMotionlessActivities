 ...
 */
package featureextractionfinal.gym;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2648; i++) {
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/gym/" + i + "/sound.txt");
                ...
                try {
                    ...
                    try (FileWriter fw = new FileWriter("results/gym/sound.txt", true);
