 ...
 */
package featureextractionfinal.bar;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2330; i++) {
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/bar/" + i + "/sound.txt");
                ...
                try (FileWriter fw = new FileWriter("results/bar/sound.txt", true);
