 ...
 */
package featureextractionfinal.going_down_stairs;
...
public class FeatureExtractionAccelerometerMagnetometerGyroscope {
    ...
    public static String getRow(String folder, String filename) {
        ...
        try {
            ...
            FileReader fileReader = new FileReader("data/downstairs/" + folder + "/" + filename + ".txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2000; i++) {
            ...
            try (FileWriter fw = new FileWriter("results/downstairs/accelerometer_magnetometer_gyroscope.txt", true);
