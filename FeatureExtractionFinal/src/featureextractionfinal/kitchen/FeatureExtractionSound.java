 ...
 */
package featureextractionfinal.kitchen;
...
public class FeatureExtractionSound {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2119; i++) {
            ...
            File dir = new File("data/kitchen/" + i);
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/kitchen/" + i + "/sound.txt");
                ...
                try {
                    ...
                    try (FileWriter fw = new FileWriter("results/kitchen/sound.txt", true);
