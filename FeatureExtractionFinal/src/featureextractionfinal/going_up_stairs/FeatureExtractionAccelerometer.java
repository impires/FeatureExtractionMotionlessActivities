    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2075; i++) {
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/upstairs/" + i + "/accelerometer.txt");
                ...
                try (FileWriter fw = new FileWriter("results/upstairs/accelerometer.txt", true);
