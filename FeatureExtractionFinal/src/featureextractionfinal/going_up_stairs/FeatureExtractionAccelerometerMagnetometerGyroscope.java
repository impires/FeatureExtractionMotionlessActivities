 ...
 */
package featureextractionfinal.going_up_stairs;
...
public class FeatureExtractionAccelerometerMagnetometerGyroscope {
    ...
    public static String getRow(String folder, String filename) {
        ...
        try {
            ...
            FileReader fileReader = new FileReader("data/upstairs/" + folder + "/" + filename + ".txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2074; i++) {
            ...
            try (FileWriter fw = new FileWriter("results/upstairs/accelerometer_magnetometer_gyroscope.txt", true);
