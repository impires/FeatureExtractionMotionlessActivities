 ...
 */
package featureextractionfinal.watching_tv;
...
public class FeatureExtractionSound {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 3042; i++) {
            ...
            File dir = new File("data/standing/" + i);
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/standing/" + i + "/sound.txt");
                ...
                try {
                    ...
                    try (FileWriter fw = new FileWriter("results/watching_tv/sound.txt", true);
