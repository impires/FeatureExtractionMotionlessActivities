 ...
 */
package featureextractionfinal.library;
...
public class FeatureExtractionSound {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2173; i++) {
            ...
            File dir = new File("data/library/" + i);
            ...
            try {
                ...
                FileReader fileReader = new FileReader("data/library/" + i + "/sound.txt");
                ...
                try {
                    ...
                    try (FileWriter fw = new FileWriter("results/library/sound.txt", true);
