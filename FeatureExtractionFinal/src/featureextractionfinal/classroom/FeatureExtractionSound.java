 ...
 */
package featureextractionfinal.classroom;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2131; i++) {
            ...
            try {
                ...
                File dir = new File("data/classroom/" + i);
                ...
                FileReader fileReader = new FileReader("data/classroom/" + i + "/sound.txt");
                ...
                try (FileWriter fw = new FileWriter("results/classroom/sound.txt", true);
                ...
                Logger.getLogger(FeatureExtractionSound.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
