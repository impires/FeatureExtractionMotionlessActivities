    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 2521; i++) {
            ...
            try {
                ...
                File dir = new File("data/sleeping/" + i);
                ...
                FileReader fileReader = new FileReader("data/sleeping/" + i + "/sound.txt");
                ...
                try (FileWriter fw = new FileWriter("results/sleeping_bedroom/sound.txt", true);
